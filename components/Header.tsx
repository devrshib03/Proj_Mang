  ...
  return (
    <header className="w-full flex items-center justify-between px-8 py-4 border-b bg-white dark:bg-[#181f2a] dark:border-gray-800">
      ...
      <nav className="flex gap-8">
        ...
        <Link href="#features" className="text-black dark:text-white">
          Features
        </Link>
        ...
        {isVerified ? (
          <>
            ...
            <div className="relative">
              <Link
                href="/signup"
                className="px-6 py-2 rounded-lg text-lg font-medium shadow bg-indigo-700 hover:bg-indigo-800 text-white dark:bg-blue-700 dark:hover:bg-blue-800"
              >
                Get Started
              </Link>
            </div>
