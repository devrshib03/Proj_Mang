  ...
  return (
    <div className="flex items-center min-h-screen justify-center rounded-xl dark:bg-gray-900 text-white p-4">
      <motion.div
        ...
        className="max-w-md min-w-96 w-full dark:bg-gray-800 bg-opacity-50 backdrop-filter border-blue-500 border-2 rounded-2xl backdrop-blur-xl shadow-xl overflow-hidden"
      >
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit}>
            <div className="mb-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 dark:bg-gray-700 bg-opacity-50 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 transition-colors duration-200"
                />
              </div>
            </div>
            <div className="mb-4">
            ...
            <div className="mb-4">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 dark:bg-gray-700 bg-opacity-50 border border-gray-600 rounded-lg dark:text-white placeholder-gray-400 focus:outline-none focus:border-blue-500 transition-colors duration-200"
                />
              </div>
            </div>
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="mt-5 w-full py-3 px-4 bg-blue-600 text-white font-bold rounded-lg shadow-lg hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 focus:ring-offset-gray-900 transition duration-200"
              type="submit"
              disabled={isLoading}
            >
              {isLoading ? (
